...
PRINT 'Stored Procedure sp_listar_promociones_validas_carrito creado exitosamente';
PRINT 'Este SP muestra solo promociones válidas para TODAS las fechas de reservas en el carrito';
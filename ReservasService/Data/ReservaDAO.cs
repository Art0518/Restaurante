...
namespace ReservasService.Data
{
    public class ReservaDAO
    {
        ...
        public ReservaDAO(string connectionString)
        {
   ...
   {
SqlCommand cmd = new SqlCommand("usp_Reserva_Crear", cn);
  ...
  da.Fill(dt);
    ...
    try
           ...
           using (SqlConnection cn = new SqlConnection(_connectionString))
     {
             SqlCommand cmd = new SqlCommand("usp_Reserva_ObtenerPorId", cn);
        cmd.CommandType = CommandType.StoredProcedure;
  ...
  // ?? Listar todas las reservas
        ...
        public DataTable ListarReservas()
        {
            using (SqlConnection cn = new SqlConnection(_connectionString))
    {
       SqlCommand cmd = new SqlCommand("usp_Reserva_ListarTodas", cn);
                cmd.CommandType = CommandType.StoredProcedure;
     ...
     DataTable dt = new DataTable();
        ...
        // ============================================================
    public void ActualizarEstado(int idReserva, string nuevoEstado, string metodoPago)
        {
         using (SqlConnection cn = new SqlConnection(_connectionString))
            {
          SqlCommand cmd = new SqlCommand("usp_Reserva_ActualizarEstado", cn);
       cmd.CommandType = CommandType.StoredProcedure;
...
cmd.ExecuteNonQuery();
  ...
  // ? Editar reserva completa (sin estado)
        ...
        public string EditarReserva(Reserva r)
        {
          using (SqlConnection cn = new SqlConnection(_connectionString))
        {
             SqlCommand cmd = new SqlCommand("usp_Reserva_Actualizar", cn);
          cmd.CommandType = CommandType.StoredProcedure;
 ...
 cmd.Parameters.AddWithValue("@Fecha", r.Fecha);
  ...
  cmd.Parameters.AddWithValue("@Observaciones", r.Observaciones ?? "");
          ...
          cn.Open();
    string resp = cmd.ExecuteScalar()?.ToString() ?? "Actualizado";
                cn.Close();
 ...
 return resp;
   ...
   using (SqlConnection cn = new SqlConnection(_connectionString))
            {
          SqlCommand cmd = new SqlCommand("usp_Reserva_ObtenerDetalle", cn);
        cmd.CommandType = CommandType.StoredProcedure;
        cmd.Parameters.AddWithValue("@idReserva", idReserva);
...
cmd.CommandType = CommandType.StoredProcedure;
      ...
      catch (Exception ex)
 {
      ...
      // ============================================================
  public DataTable ConfirmarReservasSelectivas(int idUsuario, string reservasIds, string metodoPago, decimal montoDescuento, decimal total)
        {
      try
            {
      using (SqlConnection cn = new SqlConnection(_connectionString))

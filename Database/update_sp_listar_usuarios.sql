-- ============================================================
-- Script para actualizar sp_listar_usuarios con paginación
-- ============================================================
...
-- Crear el procedimiento con paginación
...
PRINT 'Procedimiento seguridad.sp_listar_usuarios actualizado correctamente';
GO
